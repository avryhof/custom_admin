...
from custom_admin.email import send_multipart_email
...
class EmailReport(models.Model):
    ...
    def send(self, subject, template_path, context_dict, **kwargs):
        if self.enabled:
            ...
            return send_multipart_email(
                subject, to_list, kwargs.get("from", None), template_path, context_dict, fail_silently=False,
            )
